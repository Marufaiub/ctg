...
<title>Hot Deals in Bangladesh | Largest online  Shop in Bangladesh</title>
...
$key2=mysql_query("SELECT product_name FROM product WHERE category_id=8");
	...
	<div id="mainbody">
        ...
        <div id="content">
            ...
            <!--start content_body_middle-->
                <?php include('hot_deals_details.php') ?>
