...
<body style="margin:0 auto; width:600px;">
 			<div id="order_page">                   
                 <div class="order_page_bg" style="background:#ffffff; border:1px #000 solid; width:558px; height:auto; padding-bottom:0px; float:left;">
                 	<div class="purchase">
                    	<h3 class="order_pur" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:18px; margin:5px 0 0 5px; border-bottom:2px #000 solid; width:538px; padding-bottom:0px;">Your Purchase</h3>
                        ...
                        <table cellpadding="5" cellspacing="0" width="100%" style="margin:10px 10px 0 10px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:14px;">
                            ...
                            <tr>
                              	<td style="padding-bottom:0px;"><input id="user_firstname" name="user[firstname]" size="30" type="text" value="" /></td>
                              	<td style="padding-bottom:0px;"><input name="user[email]" size="30" type="text" value="" /></td>
                            </tr>
                            ...
                            <tr>
                              	...
                              	<td valign="top"><input class="phone" id="user_phone" name="user[phone]" size="30" style="width:160px;margin-bottom:0px" type="text" /></td>
                            </tr>
