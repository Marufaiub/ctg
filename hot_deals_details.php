<script>
document.getElementById('hot').setAttribute("class","selected");
</script>
		...
		//	$query=mysql_query("SELECT * FROM product WHERE discount_available='yes' ORDER BY product_id DESC");
			 ...
			 $MySQL = "
								...
								FROM
									product
					WHERE discount_available='yes' ORDER BY product_id DESC
								LIMIT
			...
			?>
                    ...
                    <div class="man_page_bg gap" id="p_pic">
                    	<a  href="view_page.php?product_id=<?php echo $product_id; ?>" target="_blank"><img src="<?php echo 'admin/'.$dif_pic_url; ?>" alt="<?php echo $data['product_name']; ?>" title="<?php echo $data['product_name']; ?>" style="width:170px; height:170px;" /></a>
                        <div class="featured_pro_name"><h3 class="pro_name"><?php echo $product_name; ?></h3></div><!--end product name-->
                        <h3 class="price" style="display:inline;">৳ <?php echo $price; ?>
