   ...
   <div class="box_skitter box_skitter_large">
					<ul>
                     ...
                     <?php
						 ...
						 {
							$pic='admin/'.$data['picture_url'];	
							$title=$data['title'];	
							$description=$data['description'];	
							
						 ?>
                    
						<li><a href="#"><img src="<?php echo $pic; ?>" class="cube" /></a><!--<div class="label_text"><p><?php echo $title; ?></p></div>--></li>
                ...
                <div id="products" style="margin-top:50px;">
...
?>                   
					...
					//$MySQL=mysql_query("SELECT * FROM home_page_product");
					...
					while($h_data=mysql_fetch_assoc($result))
					{
						$index = 0;
						
						$hp_id=$h_data['product_id'];
					
					
					$query=mysql_query("SELECT * FROM product WHERE product_id='$hp_id'");
                    ...
                    <div class="product_bg gap" id="p_pic">
                    	<a  href="view_page.php?product_id=<?php echo $product_id; ?>" target="_blank"><img  src="<?php echo 'admin/'.$picture; ?>" alt="<?php echo $data['product_name']; ?>" title="<?php echo $data['product_name']; ?>" style="height:170px; width:170px;" /> </a>
                        <div class="featured_pro_name"><h3 class="pro_name"><?php echo $data['product_name']; ?></h3></div><!--end product name-->
                        <h3 class="price">৳ <?php echo $price; ?>
                        	 <?php 
                        if($discount_available == 'yes')
						{
						?>
                        <span style="color:#999; text-decoration:line-through; margin-left:5px;">৳ <?php echo $old_price; ?></span>
                        <?php
                        }
                        ?>
                        </h3>
                    ...
                    <div id='LightBox<?php echo $product_id; ?>' class="box_content" style="display:none;"> 
                 ...
                 <div class="order_page_bg">
                 	<div class="purchase">
                        ...
                        <a onclick="displayHideBox('<?php echo $product_id;?>'); return false;" style="float:right; margin-right:5px;  cursor:pointer;"><img src="images/close.png" title="Close" style="width:80px;" /></a>
                        ...
                        <input type="hidden" name="product_id" value="<?php echo $product_id; ?>" />
                        	<table width="100%" border="0" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:14px; margin-top:5px;">
                              ...
                              <tr>
                                ...
                                <td style=" text-align:center; padding-top:0px;"><input onchange="total(<?php echo $price;?>,<?php echo $product_id;?>)"  maxlength="4" name="quantity" id="quantity-<?php echo $product_id; ?>" required="required" size="5" type="text" value="1" style="text-align:center" />
                                ...
                                <td style=" text-align:center; padding-top:0px;">৳ <?php echo $price; ?></td>
                                <td style=" text-align:center; padding-top:0px;">৳ <p id="total_<?php echo $product_id; ?>" style="display:inline;"><?php echo $price; ?></p></td>
                              </tr>
                            </table>
                            ...
                            <tr>
                               ...
                               <td>
                                <?php
									...
									$question="$n1 + $n2 = ?";
									?>
                                 <p style="color:#090;">Please, Answer the Summation Value of <br/> <?php echo $question.PHP_EOL; ?> </p>
